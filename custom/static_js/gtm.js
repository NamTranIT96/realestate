...
(function () {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 99,
                "once_per_event": true,
                "vtp_html": "\n\u003Cscript type=\"text\/gtmscript\"\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js.js\");fbq(\"init\",\"1821624764800433\");\u003C\/script\u003E\n",
                ...
                "vtp_uniqueTriggerId": "10098620_5",
                "tag_id": 6
            }, {
                "function": "__lcl",
                "vtp_waitForTags": false,
                "vtp_checkValidation": false,
                "vtp_waitForTagsTimeout": "2000",
                "vtp_uniqueTriggerId": "10098620_9",
                "tag_id": 7
            }, {
                "function": "__html",
                "once_per_event": true,
    ...
    var f, aa = this, fa = function () {
        if (null === ba) a:{
            var a = aa.document, b = a.querySelector && a.querySelector("script[nonce]");
            if (b) {
        ...
        return ba
    }, ea = /^[\w+/_-]+[=]{0,2}$/, ba = null, ha = function (a) {
        var b = typeof a;
    ...
    var sa = function () {
        ...
        if (a && wa(a)) for (var c = 0; c < a.length; c++) if (a[c] && b(a[c])) return a[c]
    }, za = function (a, b) {
        if (!va(a) ||
    ...
    var Pa = /^([a-z]*):(!|\?)(\*|string|boolean|number|Fn|Map|List)$/i,
        Qa = {Fn: "function", Map: "Object", List: "Array"}, Ra = function (a, b) {
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    var Sa = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/, Ta = function (a) {
        ...
        control: function (a, b) {
            ...
            return new x(a, function () {
                return function (a) {
                    ...
                    d.Bb && b.S(d.Bb);
                    for (var c = Array.prototype.slice.call(arguments, 0), h = 0; h < c.length; h++) if (c[h] = this.evaluate(c[h]), c[h] instanceof ja) return c[h];
                    for (var p =
            ...
            for (var b = this.L(), c = new Oa, d = 0; d < arguments.length - 1; d += 2) {
                var e = this.evaluate(arguments[d]) + "", g =
                    this.evaluate(arguments[d + 1]), h = e.length;
    ...
    var ab = {
        ...
        some: function (a, b) {
            for (var c = this.length(), d = 0; d < this.length() && d < c; d++) if (this.has(d) && b.B(a, this.get(d), d, this)) return !0;
            return !1
        },
        sort: function (a, b) {
            var c = $a(this);
    ...
    var z = {
        ...
        cb = new ja("break"), db = new ja("continue");
    z.add = function (a, b) {
    ...
    z.rf = function (a, b, c) {
        ...
        } else if (b instanceof Oa || b instanceof n || b instanceof x) for (var h = b.da(), k = h.length(), l = 0; l < k; l++) {
            d.set(a, h.get(l));
            var m = this.Ua(c);
            if (m instanceof ja) {
                if ("break" == m.C) break;
    ...
    var B = window, C = document, hb = navigator, lb = C.currentScript && C.currentScript.src, mb = function (a, b) {
        var c = B[a];
        B[a] = void 0 === c ? b : c;
        return B[a]
    }, nb = function (a, b) {
    ...
    var Gb = function (a, b, c) {
        ...
        if ("auto" === d) {
            var p = !1, q;
            a:{
                var r = [], u = document.location.hostname.split(".");
                if (4 === u.length) {
                    var w = u[u.length - 1];
    ...
    function Hb(a, b) {
        for (var c = [], d = Gb(a), e = 0; e < d.length; e++) {
            ...
            if (!b || -1 !== b.indexOf(h)) {
                var k = g.shift();
                k && (k = k.split("-"), c.push({id: g.join("."), jf: 1 * k[0] || 1, $f: 1 * k[1] || 1}))
            }
        }
        return c
    }

    var Lb = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/, Kb = /(^|\.)doubleclick\.net$/i;
    var Pb = function () {
        this.Fa = new fb;
        var a = new gb;
        a.addAll(Nb());
    ...
    function Tb(a) {
        Ra(["path:!string"], arguments);
        this.F().assert("access_globals", "readwrite", a);
        var b = lc(a), c = a.split(".").pop(), d = b[c];
        void 0 === d && (d = [], b[c] = d);
        return Xa(function () {
    ...
    function Ub(a, b) {
        ...
        var c = lc(a), d = a.split(".").pop(), e = c[d];
    ...
    function mc(a) {
        for (var b = 0; b < a.length; b++) {
            var c = a[b];
            c && ha(c) && Object.defineProperty(c, "gtm", {value: {fromContainer: !0}})
        }
    }

    function lc(a) {
        for (var b = a.split("."), c = B, d = 0; d < b.length - 1; d++) if (c = c[b[d]], void 0 === c) throw Error("Path " + a + " does not exist.");
        return c
    }
    ...
    };var Jc, Kc = [], Lc = [], Mc = [], Nc = [], Oc = [], Pc = {}, Qc, Rc, Sc, Tc = function (a, b) {
        var c = {};
        c["function"] = "__" + a;
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
    ...
    var id = hd, jd = null, kd = null, ld = "//www.googletagmanager.com/a?id=" + fd.o + "&cv=3", md = {}, nd = {},
        od = function () {
            var a = gd.sequence || 0;
            gd.sequence = a + 1;
            return a
        ...
        return function (h) {
            ...
            if (d) {
                ...
                if (!(u = 0 <= xa(e, k))) a:{
                    ...
                    for (var G = 0; G < w.length; G++) if (v.get(w[G])) {
                        u = !0;
                        break a
                    }
                    u = !1
    ...
    var Sd = function () {
        ...
        if (!gd._li && B.performance && B.performance.timing) {
            var b = B.performance.timing.navigationStart, c = va(wd.get("gtm.start")) ? wd.get("gtm.start") : 0;
            gd._li = {cst: a(c - b), cbt: a(jd - b)}
        }
    };
    var Td = !1, Ud = function () {
    ...
    }, qe = "0.005000" > Math.random(), ne = pe(), re = function () {
        ne = pe()
    }, ge = {}, he = "", fe = void 0, oe = {}, ie = {}, ee =
        void 0, je = function (a, b) {
        var c = 0, d = 0;
        return {
            Lf: function () {
                if (c < a) return !1;
    ...
    }(2, 1E3), ke = 1E3, se = function (a, b, c) {
        if (qe && !ie[a] && b) {
            a !== fe && (me(), fe = a);
    ...
    function ue(a, b, c, d, e, g) {
        ...
        var l = ve(), m = Vc(k[N.cd], g.ia, [], l);
        if (m && m.length) {
            var p = m[0], q = te(p.index, b, c, d, e, g);
            if (!q) return null;
            c = q;
            d = 2 === p.nd ? e : q
        }
        if (k[N.ad] || k[N.ue]) {
            var r = k[N.ad] ? Oc : b, u = c, w = d;
            if (!r[a]) {
                h = Ia(h);
                var v = xe(a, r, h);
                c = v.X;
    ...
    function De(a, b) {
        if (!qe) return;
        var c = function (a) {
            var d = b.ia(Nc[a]) ? "3" : "4", g = Vc(Nc[a][N.bd], b.ia, [], sa);
    ...
    var ff = function () {
        for (var a = !1; !df && 0 < cf.length;) {
            ...
            if (ta(b)) try {
                ...
                var c = b;
                if (t(c[0])) {
                    var d = c[0].split("."), e = d.pop(), g = c.slice(1), h = vd(d.join("."), 2);
                ...
                if (u) {
                    ...
                    kd = u;
                    var v;
                    var D, G, A = q, I = A.event, O = A["gtm.uniqueEventId"], P = gd.zones;
                    ...
                    if (G.active) {
                        ...
                        c:{
                            ...
                            var R = Hd(V), ca = {id: O, name: I, callback: F || sa, ia: R, Za: []};
                            ca.Za = cd(R);
                            for (var qa, Ca = ca, ib = Be(Ca.callback), jb = [], zb = [], kb = 0; kb < Nc.length; kb++) if (Ca.Za[kb]) {
                                var We =
                                    Nc[kb];
                                var dc = ib.add();
                                try {
                                    var Xe = te(kb, jb, dc, dc, dc, Ca);
                                    Xe ? zb.push({Rd: kb, b: Xc(We), M: Xe}) : (De(kb, Ca), dc())
                                } catch (Ve) {
                                    dc()
                                }
                            }
                            ...
                            if (qa) {
                                for (var nh = {
                                    ...
                                    __tl: !0,
                                    __ytl: !0
                                }, Hc = 0; Hc < ca.Za.length; Hc++) if (ca.Za[Hc]) {
                                    var Ze = Nc[Hc];
                                    if (Ze && !nh[Ze[N.wa]]) {
                                        D = !0;
                                        break c
    ...
    function nf(a, b) {
        function c(a) {
            var b = H(a), c = Fb(b, "protocol"), d = Fb(b, "host", !0), e = Fb(b, "port"),
    ...
    var ag, cg, dg = function (a) {
        ...
        for (var b = [], c = 0; c < a.length; c += 3) {
            var d = c + 1 < a.length, e = c + 2 < a.length, g = a.charCodeAt(c), h = d ? a.charCodeAt(c + 1) : 0,
                k = e ? a.charCodeAt(c + 2) : 0, l = g >> 2, m = (g & 3) << 4 | h >> 4, p = (h & 15) << 2 | k >> 6,
                q = k & 63;
            e || (q = 64, d || (p = 64));
    ...
    var ig = /(.*?)\*(.*?)\*(.*)/, jg = /^https?:\/\/([^\/]*?)\.?cdn\.ampproject\.org\/?(.*)/,
        kg = /^(?:www\.|m\.|amp\.)+/, lg = /([^?#]+)(\?[^#]*)?(#.*)?/, mg = /(.*?)(^|&)_gl=([^&]*)&?(.*)/,
        og = function (a) {
            var b = [], c;
            ...
            return function (a) {
                var b = H(B.location.href), c = b.search.replace("?", ""), d = Db(c, "_gl", !0) || "";
                a.query = pg(d) || {};
            ...
            try {
                if (a) {
                    ...
                    if (h && "1" === h[1]) {
                        var k = h[3], l;
                        a:{
                            for (var m = h[2], p = 0; p < b; ++p) if (m === ng(k, p)) {
                                l = !0;
                                break a
                            }
                            l = !1
    ...
    var ug = function (a) {
        ...
        var a = C.location.hostname, b = jg.exec(C.referrer);
        if (!b) return !1;
        var c = b[2], d = b[1], e = "";
        if (c) {
            var g = c.split("/"), h = g[1];
    ...
    var zg = /^\w+$/, Ag = /^[\w-]+$/, Bg = /^~?[\w-]+$/, Cg = {aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha"},
        Eg = function (a) {
            var b = Gb(a, C.cookie), c = [];
    ...
    var Gg = function (a) {
        ...
        var a = H(B.location.href), b = Fb(a, "query", !1, void 0, "gclid"), c = Fb(a, "query", !1, void 0, "gclsrc"),
    ...
    function Jg(a, b) {
        ...
        b = b || {};
        var d = Gg(b.prefix), e = b.domain || "auto", g = b.path || "/", h = Fa(), k = new Date(h + 7776E6),
            l = Math.round(h / 1E3), m = function (a) {
                return ["GCL", l, a].join(".")
            };
    ...
    function Og(a) {
        var b = H(B.location.href), c = Fb(b, "host", !1);
        if (c && c.match(Ng)) {
    ...
    var Pg = function (a) {
        ...
        if (d && 0 < e.length) {
            var g = gd.joined_au = gd.joined_au || {}, h = a || "_gcl";
            if (!g[h]) {
    ...
    var Xg = function (a) {
        var b = fd.o.split("-"), c = b[0].toUpperCase(), d = Vg[c] || "i", e = a && "GTM" === c ? b[1] : "";
        return (3 === fd.tb.length ? "2" + Wg() : "") + d + fd.tb + e
    };
    var dh = !!B.MutationObserver, eh = void 0, fh = function (a) {
        if (!eh) {
            var b = function () {
                var a = C.body;
    ...
    var gh = /\./g;
    var Ch = B.clearTimeout, Dh = B.setTimeout, W = function (a, b, c) {
        if (pf()) {
            b && E(b)
        ...
        for (var l = Gg(b), m = 0; m < a.length; ++m) {
            ...
            if (void 0 !== Cg[p]) {
                var q = Kg(p, l), r = h[q];
                if (r) {
                    var u = Math.min(Lg(r), Fa()), w;
                    b:{
                        for (var v = u, D = Gb(q, C.cookie), G = 0; G < D.length; ++G) if (Lg(D[G]) > v) {
                            w = !0;
                            break b
                        }
                        w = !1
        ...
        var d = (void 0 === c ?
            0 : c) ? "www.googletagmanager.com/gtag/js.js" : id;
    ...
    var si = window, ti = document, ui = function (a) {
        ...
        for (var d = Gb("AMP_TOKEN", ti.cookie, !0), e = 0; e < d.length; e++) if ("$OPT_OUT" == d[e]) return !0;
        return !1
    };
    var zi = function (a) {
        if (1 === gi(a).c) {
            ...
            ob(("http:" != B.location.protocol ? "https:" : "http:") + ("//www.googletagmanager.com/gtag/js.js?id=" + b + "&l=dataLayer&cx=c"))
        }
    }, Ai = function (a, b) {
    };
    var Y = {a: {}};
    ...
    Y.a.ua = ["google"], function () {
        var a, b = function (b) {
            ...
            var p = Vd(b.vtp_functionName), q = "", r = "";
            ...
            var u = {
                ...
                if (b) for (var c in b) b.hasOwnProperty(c) && v("set", a + c, b[c])
            }, A = function () {
            }, I = function (a, b, c) {
                var d = 0;
            ...
            if ("TRACK_EVENT" == b.vtp_trackType) {
                ...
                if (b.vtp_doubleClick || "DISPLAY_FEATURES" == b.vtp_advertisingFeaturesType) {
                    ...
                    v("require", "displayfeatures", void 0, {cookieName: ua})
                }
                if ("DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == b.vtp_advertisingFeaturesType) {
                    ...
                    v("require", "adfeatures", {cookieName: S})
                }
    ...
    Y.a.aev = ["google"], function () {
        ...
        (function (a) {
            ...
            switch (e.vtp_varType) {
                ...
                case "TEXT":
                    var k, l = Gh("gtm.element", 1), m = Gh("event", 1), u = Number(new Date);
                ...
                case "URL":
                    var w;
                    a:{
                        var v = String(Gh("gtm.elementUrl", 1) || e.vtp_defaultValue || ""), D = H(v);
    ...
    Y.a.html = ["customScripts"], function () {
        ...
        var c = function (d) {
            if (C.body) {
                var e =
                    d.vtp_gtmOnFailure, g = Sh(d.vtp_html, d.vtp_gtmOnSuccess, e), h = g.hc, k = g.X;
                if (d.vtp_useIframe) {
                } else d.vtp_supportDocumentWrite ? b(h, k, e) : a(C.body, xb(h), k, e)()
            } else Dh(function () {
                    c(d)
                },
                200)
    ...
    Y.a.lcl = [], function () {
        function a() {
            var a = X("document"), d = 0, e = function (c) {
                var e = c.target;
                if (e && 3 !== c.which && (!c.timeStamp || c.timeStamp !== d)) {
                    d = c.timeStamp;
                    e = yb(e, ["a", "area"], 100);
                    if (!e) return c.returnValue;
                    var g = c.defaultPrevented || !1 === c.returnValue, l = Lf("lcl", g ? "nv.mwt" : "mwt", 0),
                        m = If(e);
                    m.event = "gtm.linkClick";
                    if (g) {
                        var p = Lf("lcl", "nv.ids", []).join(",");
                        if (p) m["gtm.triggers"] = p; else return
                    } else {
                    ...
                    if (b(c, e, a) && !g && l && e.href) {
                        var r = X((e.target ||
                            "_self").substring(1)), u = !0;
                        if (Hh(m, function () {
                            u && r && (r.location.href = e.href)
                        }, l)) u = !1; else return c.preventDefault && c.preventDefault(), c.returnValue = !1
                    } else Hh(m, function () {
                    }, l || 2E3);
                    return !0
                }
        ...
        function b(a, b, e) {
            ...
            if (0 < c) {
                var k = Eb(H(b.href)), l = Eb(H(e.location));
                return k !== l
            }
            return !0
        }
        ...
        (function (a) {
            ...
            var c = void 0 === b.vtp_waitForTags ? !0 : b.vtp_waitForTags,
                e = void 0 === b.vtp_checkValidation ? !0 : b.vtp_checkValidation, g = Number(b.vtp_waitForTagsTimeout);
            if (!g || 0 >= g) g = 2E3;
    ...
    Bi.Gf = function () {
        ...
        if (gd[fd.o]) {
            ...
            Md = !1;
            Nd = 0;
            if ("interactive" == C.readyState && !C.createEventObject || "complete" == C.readyState) Pd(); else {
