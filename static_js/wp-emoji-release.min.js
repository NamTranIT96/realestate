// Source: wp-includes/js.js/twemoji.min.js.js
var twemoji = function () {
    ...
    function l(a, b) {
        return b && "function" != typeof b || (b = {callback: b}), ("string" == typeof a ? g : f)(a, {
    ...
    var p = {
        ...
        s = /\uFE0F/g, t = String.fromCharCode(8205), u = /[&<>'"]/g,
        v = /^(?:iframe|noframes|noscript|script|select|style|textarea)$/, w = String.fromCharCode;
    return p
}();
// Source: wp-includes/js.js/wp-emoji.min.js.js
!function (a, b) {
    function c() {
        function c() {
                    ...
                    for (var b, c, d, g, h = a.length; h--;) {
                        ...
                        for (; d--;) {
                            if (g = b[d], 3 === g.nodeType) {
                                ...
                                if (m) for (; g.nextSibling && 3 === g.nextSibling.nodeType;) g.nodeValue = g.nodeValue + g.nextSibling.nodeValue, g.parentNode.removeChild(g.nextSibling);
                                g = g.parentNode
                            }
        ...
        var g, h, i = a.MutationObserver || a.WebKitMutationObserver || a.MozMutationObserver, j = a.document, k = !1,
            l = 0, m = a.navigator.userAgent.indexOf("Trident/7.0") > 0;
